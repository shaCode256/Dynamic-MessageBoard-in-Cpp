...
TEST_CASE("THIS IS read right random"){
	ariel::Board b;
	...
	for (size_t i = 0; i < lengthS; i++)
	{
		...
		for (size_t i = 0; i < lengthS; i++)
		{
			...
			cout << "***srComp is" << srComp << "scComp is" << scComp << "***" << "\n";
			cout << "\n sr.at(i) is" << sr.at(i) << "|srComp.at(i) is" << srComp.at(i) << "|\n";
			CHECK_EQ(sc.at(i), scComp.at(i));
			cout<<"i is " << i << "\n";
			cout << "\n sc.at(i) is" << sc.at(i) << "|scComp.at(i) is" << scComp.at(i) << "|\n";
